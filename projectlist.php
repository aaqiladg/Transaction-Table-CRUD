    ...
    <?php
        ...
        if(count($arrayResult) == 0){
            ...
            foreach ($arrayResult as $dataProject) {
                ...
                echo '<td> <a class="btn btn-warning btn-sm" href="index.php?project&pnumber='.$dataProject->pnumber.'">Edit</a> \ <a class "btn btn-danger btn-sm" href="index.php?p=deleteproject&pnumber='.$dataProject->pnumber.'"
